...
export default function SUS({
  ...
  // Require SUS plus at least one open response
  const allAnswered =
      ...
      {SUS_QUESTIONS.map((question, index) => (
        <div key={index} style={{ marginBottom: "1.75rem" }}>
          ...
          <table>
            <tbody>
              <tr>
                <td style={{ paddingRight: "0.75rem", fontSize: "0.8rem", color: "#555", whiteSpace: "nowrap" }}>
                  Strongly Disagree
                </td>

                {[1, 2, 3, 4, 5].map(n => (
                  <td key={n} style={{ textAlign: "center", padding: "0 0.5rem", fontSize: "0.9rem" }}>
                    {n}
                  </td>
                ))}

                <td style={{ paddingLeft: "0.75rem", fontSize: "0.8rem", color: "#555", whiteSpace: "nowrap" }}>
                  Strongly Agree
                </td>
              </tr>
              ...
              <tr>
                <td />
                {[1, 2, 3, 4, 5].map(value => (
                  <td key={value} style={{ textAlign: "center", padding: "0 0.5rem" }}>
                    <input
                      type="radio"
                      name={`sus-${index}`}
                      value={value}
